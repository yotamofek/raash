...
pub type TXSample = libc::c_float;
pub type TXUSample = libc::c_float;
...
unsafe extern "C" fn ff_tx_init_tab_524288_float() {
    ...
    while i < 524288 as libc::c_int / 4 as libc::c_int {
        let fresh0 = tab;
        tab = tab.offset(1);
        *fresh0 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
...
unsafe extern "C" fn ff_tx_init_tab_2048_float() {
    ...
    while i < 2048 as libc::c_int / 4 as libc::c_int {
        let fresh1 = tab;
        tab = tab.offset(1);
        *fresh1 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_8_float() {
    ...
    while i < 8 as libc::c_int / 4 as libc::c_int {
        let fresh2 = tab;
        tab = tab.offset(1);
        *fresh2 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_128_float() {
    ...
    while i < 128 as libc::c_int / 4 as libc::c_int {
        let fresh3 = tab;
        tab = tab.offset(1);
        *fresh3 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_32_float() {
    ...
    while i < 32 as libc::c_int / 4 as libc::c_int {
        let fresh4 = tab;
        tab = tab.offset(1);
        *fresh4 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_256_float() {
    ...
    while i < 256 as libc::c_int / 4 as libc::c_int {
        let fresh5 = tab;
        tab = tab.offset(1);
        *fresh5 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_512_float() {
    ...
    while i < 512 as libc::c_int / 4 as libc::c_int {
        let fresh6 = tab;
        tab = tab.offset(1);
        *fresh6 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_32768_float() {
    ...
    while i < 32768 as libc::c_int / 4 as libc::c_int {
        let fresh7 = tab;
        tab = tab.offset(1);
        *fresh7 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_16384_float() {
    ...
    while i < 16384 as libc::c_int / 4 as libc::c_int {
        let fresh8 = tab;
        tab = tab.offset(1);
        *fresh8 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_4096_float() {
    ...
    while i < 4096 as libc::c_int / 4 as libc::c_int {
        let fresh9 = tab;
        tab = tab.offset(1);
        *fresh9 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_16_float() {
    ...
    while i < 16 as libc::c_int / 4 as libc::c_int {
        let fresh10 = tab;
        tab = tab.offset(1);
        *fresh10 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_8192_float() {
    ...
    while i < 8192 as libc::c_int / 4 as libc::c_int {
        let fresh11 = tab;
        tab = tab.offset(1);
        *fresh11 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_1024_float() {
    ...
    while i < 1024 as libc::c_int / 4 as libc::c_int {
        let fresh12 = tab;
        tab = tab.offset(1);
        *fresh12 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_65536_float() {
    ...
    while i < 65536 as libc::c_int / 4 as libc::c_int {
        let fresh13 = tab;
        tab = tab.offset(1);
        *fresh13 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_131072_float() {
    ...
    while i < 131072 as libc::c_int / 4 as libc::c_int {
        let fresh14 = tab;
        tab = tab.offset(1);
        *fresh14 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_262144_float() {
    ...
    while i < 262144 as libc::c_int / 4 as libc::c_int {
        let fresh15 = tab;
        tab = tab.offset(1);
        *fresh15 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_64_float() {
    ...
    while i < 64 as libc::c_int / 4 as libc::c_int {
        let fresh16 = tab;
        tab = tab.offset(1);
        *fresh16 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_1048576_float() {
    ...
    while i < 1048576 as libc::c_int / 4 as libc::c_int {
        let fresh17 = tab;
        tab = tab.offset(1);
        *fresh17 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_2097152_float() {
    ...
    while i < 2097152 as libc::c_int / 4 as libc::c_int {
        let fresh18 = tab;
        tab = tab.offset(1);
        *fresh18 = cos(i as libc::c_double * freq) as TXSample;
        i += 1;
        i;
    }
    *tab = 0 as libc::c_int as TXSample;
...
unsafe extern "C" fn ff_tx_init_tab_53_float() {
    ff_tx_tab_53_float[0 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 5 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[1 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 5 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[2 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 10 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[3 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 10 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[4 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 5 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[5 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 5 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[6 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 10 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[7 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 10 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[8 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 12 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[9 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 12 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[10 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 6 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_53_float[11 as libc::c_int as usize] = cos(8 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 6 as libc::c_int as libc::c_double)
        as TXSample;
}
...
unsafe extern "C" fn ff_tx_init_tab_7_float() {
    ff_tx_tab_7_float[0 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 7 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_7_float[1 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 7 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_7_float[2 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 28 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_7_float[3 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 28 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_7_float[4 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 14 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_7_float[5 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 14 as libc::c_int as libc::c_double)
        as TXSample;
}
...
unsafe extern "C" fn ff_tx_init_tab_9_float() {
    ff_tx_tab_9_float[0 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 3 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_9_float[1 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 3 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_9_float[2 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 9 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_9_float[3 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 9 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_9_float[4 as libc::c_int as usize] = cos(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 36 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_9_float[5 as libc::c_int as usize] = sin(2 as libc::c_int as libc::c_double
        * 3.14159265358979323846f64
        / 36 as libc::c_int as libc::c_double)
        as TXSample;
    ff_tx_tab_9_float[6 as libc::c_int as usize] =
        ff_tx_tab_9_float[2 as libc::c_int as usize] + ff_tx_tab_9_float[5 as libc::c_int as usize];
    ff_tx_tab_9_float[7 as libc::c_int as usize] =
        ff_tx_tab_9_float[3 as libc::c_int as usize] - ff_tx_tab_9_float[4 as libc::c_int as usize];
}
...
static mut nptwo_tabs_init_once: [pthread_once_t; 3] =
    [0 as libc::c_int, 0 as libc::c_int, 0 as libc::c_int];
#[no_mangle]
#[cold]
pub unsafe extern "C" fn ff_tx_init_tabs_float(mut len: libc::c_int) {
...
static mut ff_tx_fft3_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft3_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft3_float_c
...
static mut ff_tx_fft3_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft3_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft3_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft5_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft5_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft5_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft5_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft5_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft5_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft7_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft7_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft7_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft7_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft7_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft7_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft9_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft9_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft9_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft9_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft9_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft9_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft15_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft15_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft15_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
unsafe extern "C" fn ff_tx_fft8_ns_float_c(
    ...
    let mut r1: TXUSample = 0.;
    let mut i1: TXUSample = 0.;
    let cos_0: TXSample = ff_tx_tab_8_float[1 as libc::c_int as usize];
...
static mut ff_tx_fft2_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft2_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_fft4_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft4_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft4_ns_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft8_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft8_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft8_ns_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft16_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft16_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_fft32_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft32_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft32_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 8 as libc::c_int >> 1 as libc::c_int);
}
unsafe extern "C" fn ff_tx_fft64_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 16 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft64_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft64_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft128_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 32 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft128_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft128_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft256_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 64 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft256_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft256_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft512_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 128 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft512_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft512_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft1024_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 256 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft1024_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft1024_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft2048_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 512 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft2048_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft2048_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft4096_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 1024 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft4096_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft4096_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_fft8192_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft8192_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft8192_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 2048 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft16384_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft16384_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft16384_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 4096 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft32768_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft32768_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft32768_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 8192 as libc::c_int >> 1 as libc::c_int);
}
unsafe extern "C" fn ff_tx_fft65536_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 16384 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft65536_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft65536_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_fft131072_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft131072_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft131072_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 32768 as libc::c_int >> 1 as libc::c_int);
}
unsafe extern "C" fn ff_tx_fft262144_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 65536 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft262144_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft262144_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_fft524288_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft524288_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft524288_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 131072 as libc::c_int >> 1 as libc::c_int);
}
unsafe extern "C" fn ff_tx_fft1048576_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 262144 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft1048576_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft1048576_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft2097152_ns_float_c(
    ...
    ff_tx_fft_sr_combine_float_c(dst, cos_0, 524288 as libc::c_int >> 1 as libc::c_int);
}
static mut ff_tx_fft2097152_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft2097152_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft_float_c(
    ...
    let mut dst1: *mut TXComplex =
        (if (*s).flags & AV_TX_INPLACE as libc::c_int as libc::c_ulong != 0 {
            (*s).tmp.float as *mut libc::c_void
        } else {
            _dst
        }) as *mut TXComplex;
...
static mut ff_tx_fft_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft_inplace_small_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft_inplace_small_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_fft_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_fft_inplace_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft_inplace_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
    ...
    while i < len {
        ...
        while j < len {
            ...
            *((*s).exp).float.offset((i * j) as isize) = {
                let mut init = AVComplexFloat {
                    re: cos(factor) as libc::c_float,
                    im: sin(factor) as libc::c_float,
                };
                init
            };
            j += 1;
...
unsafe extern "C" fn ff_tx_fft_naive_float_c(
    ...
    while i < n {
        let mut tmp: TXComplex = {
            let mut init = AVComplexFloat {
                re: 0 as libc::c_int as libc::c_float,
                im: 0.,
            };
            init
        };
...
static mut ff_tx_fft_naive_small_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft_naive_small_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_fft_naive_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft_naive_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_fft_pfa_init_float_c(
    ...
    tmp = (*s).tmp.float as *mut libc::c_int;
...
unsafe extern "C" fn ff_tx_fft_pfa_float_c(
    ...
    while i < m {
        ...
        ((*s).fn_0[0 as libc::c_int as usize]).expect("non-null function pointer")(
            ...
            &mut *((*s).tmp)
                ...
                as *mut libc::c_void,
            (*s).exp.float as *mut libc::c_void,
    ...
    while i_0 < n {
        ((*s).fn_0[1 as libc::c_int as usize]).expect("non-null function pointer")(
            ...
            &mut *((*s).tmp).float.offset((m * i_0) as isize) as *mut TXComplex
                as *mut libc::c_void,
...
static mut ff_tx_fft_pfa_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft_pfa_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_fft_pfa_ns_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"fft_pfa_ns_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_mdct_naive_fwd_float_c(
    ...
    while i < len {
        ...
        while j < len * 2 as libc::c_int {
            ...
            sum += *src.offset(j as isize) as libc::c_double * cos(a as libc::c_double * phase);
            j += 1;
            j;
        }
        *dst.offset((i as libc::c_long * stride) as isize) = (sum * scale) as TXSample;
        i += 1;
        i;
    }
}
    ...
    while i < len {
        ...
        while j < len2 {
            ...
            let mut val: libc::c_double =
                *src.offset((j as libc::c_long * stride) as isize) as libc::c_double;
            sum_d += a_d * val;
            sum_u += a_u * val;
            j += 1;
            j;
        }
        *dst.offset((i + 0 as libc::c_int) as isize) = (sum_d * scale) as TXSample;
...
static mut ff_tx_mdct_naive_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_naive_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_naive_inv_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_naive_inv_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_inv_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_inv_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_inv_full_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_inv_full_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_pfa_3xM_inv_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_3xM_inv_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_mdct_pfa_3xM_inv_float_c(
    ...
    while i_0 < 3 as libc::c_int {
        ((*s).fn_0[0 as libc::c_int as usize]).expect("non-null function pointer")(
            &mut *((*s).sub).offset(0 as libc::c_int as isize),
            ((*s).tmp).float.offset((m * i_0) as isize) as *mut libc::c_void,
            ((*s).tmp).float.offset((m * i_0) as isize) as *mut libc::c_void,
            ::core::mem::size_of::<TXComplex>() as libc::c_ulong as ptrdiff_t,
        );
        i_0 += 1;
...
static mut ff_tx_mdct_pfa_5xM_inv_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_5xM_inv_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_pfa_7xM_inv_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_7xM_inv_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_pfa_9xM_inv_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_9xM_inv_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_pfa_15xM_inv_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_15xM_inv_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_pfa_3xM_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_3xM_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_pfa_5xM_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_5xM_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_pfa_7xM_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_7xM_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_pfa_9xM_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_9xM_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_mdct_pfa_15xM_fwd_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"mdct_pfa_15xM_fwd_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_rdft_init_float_c(
    ...
    *fresh31 = ((0.5f64 - 0.0f64) * m) as TXSample;
    if r2r != 0 {
        let fresh32 = tab;
        tab = tab.offset(1);
        *fresh32 = 1 as libc::c_int as libc::c_float / (*s).scale_f;
    } else {
        let fresh33 = tab;
        tab = tab.offset(1);
    ...
    let fresh34 = tab;
    tab = tab.offset(1);
    *fresh34 = ((0.5f64 - inv as libc::c_double) * m) as TXSample;
    let fresh35 = tab;
    tab = tab.offset(1);
    *fresh35 = (-(0.5f64 - inv as libc::c_double) * m) as TXSample;
    let mut i: libc::c_int = 0 as libc::c_int;
    while i < len4 {
        let fresh36 = tab;
        tab = tab.offset(1);
        *fresh36 = cos(i as libc::c_double * f) as TXSample;
        i += 1;
        i;
    }
    tab = ((*s).exp.float as *mut TXSample)
...
unsafe extern "C" fn ff_tx_rdft_r2c_float_c(
    ...
    let len2: libc::c_int = (*s).len >> 1 as libc::c_int;
    let len4: libc::c_int = (*s).len >> 2 as libc::c_int;
    let mut fact: *const TXSample = (*s).exp.float as *mut libc::c_void as *const TXSample;
    ...
    *fresh38 = 0 as libc::c_int as libc::c_float;
...
static mut ff_tx_rdft_r2r_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"rdft_r2r_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_rdft_r2r_mod2_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"rdft_r2r_mod2_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_rdft_r2i_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"rdft_r2i_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
static mut ff_tx_rdft_r2i_mod2_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"rdft_r2i_mod2_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_dct_init_float_c(
    ...
    if inv != 0 {
        ...
        while i_0 < len / 2 as libc::c_int {
            *tab.offset((len + i_0) as isize) = (0.5f64
...
unsafe extern "C" fn ff_tx_dctII_float_c(
    ...
    let len: libc::c_int = (*s).len;
    let len2: libc::c_int = len >> 1 as libc::c_int;
    let mut exp: *const TXSample = (*s).exp.float as *mut libc::c_void as *const TXSample;
    ...
    while i < len2 {
        ...
        tmp1 = ((in1 + in2) as libc::c_double * 0.5f64) as TXSample;
        tmp2 = (in1 - in2) * s_0;
...
unsafe extern "C" fn ff_tx_dctIII_float_c(
    ...
    let mut tmp2: TXSample =
        2 as libc::c_int as libc::c_float * *src.offset((len - 1 as libc::c_int) as isize);
...
static mut ff_tx_dctII_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"dctII_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_dctII_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_dctIII_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"dctIII_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
...
unsafe extern "C" fn ff_tx_dcstI_init_float_c(
    ...
    flags |= (if (*cd).type_0 as libc::c_uint == AV_TX_FLOAT_DCT_I as libc::c_int as libc::c_uint {
    ...
    ret = ff_tx_init_subtx(
        ...
        (len - 1 as libc::c_int
            + 2 as libc::c_int
                * ((*cd).type_0 as libc::c_uint == AV_TX_FLOAT_DST_I as libc::c_int as libc::c_uint)
                    as libc::c_int)
            * 2 as libc::c_int,
        0 as libc::c_int,
        &mut rsc as *mut libc::c_float as *const libc::c_void,
...
unsafe extern "C" fn ff_tx_dstI_float_c(
    ...
    let mut src: *mut TXSample = _src as *mut TXSample;
    let len: libc::c_int = (*s).len + 1 as libc::c_int;
    let mut tmp: *mut TXSample = (*s).tmp.float as *mut libc::c_void as *mut TXSample;
    stride = (stride as libc::c_ulong)
        .wrapping_div(::core::mem::size_of::<TXSample>() as libc::c_ulong) as ptrdiff_t
        as ptrdiff_t;
...
static mut ff_tx_dctI_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"dctI_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_dctI_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
static mut ff_tx_dstI_def_float_c: FFTXCodelet = unsafe {
    {
        let mut init = FFTXCodelet {
            name: b"dstI_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
                ff_tx_dstI_float_c
                    as unsafe extern "C" fn(
                        *mut AVTXContext,
...
pub unsafe extern "C" fn ff_tx_mdct_gen_exp_float(
    ...
    (*s).exp = AVTXNum {
        float: av_malloc_array(alloc, ::core::mem::size_of::<TXComplex>() as libc::c_ulong)
            as *mut TXComplex,
    };
    if ((*s).exp).float.is_null() {
        return -(12 as libc::c_int);
    ...
    while i < len4 {
        ...
        *((*s).exp).float.offset((off + i) as isize) = {
            let mut init = AVComplexFloat {
                re: (cos(alpha) * scale) as libc::c_float,
                im: (sin(alpha) * scale) as libc::c_float,
            };
            init
        };
        i += 1;
...
unsafe extern "C" fn run_static_initializers() {
    ff_tx_rdft_r2c_def_float_c = {
        let mut init = FFTXCodelet {
            name: b"rdft_r2c_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
    ...
    ff_tx_rdft_c2r_def_float_c = {
        let mut init = FFTXCodelet {
            name: b"rdft_c2r_float_c\0" as *const u8 as *const libc::c_char,
            function: Some(
