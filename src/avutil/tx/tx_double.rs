...
unsafe extern "C" fn ff_tx_init_tab_53_double() {
    ff_tx_tab_53_double[0 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 5 as c_int as c_double);
    ff_tx_tab_53_double[1 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 5 as c_int as c_double);
    ff_tx_tab_53_double[2 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 10 as c_int as c_double);
    ff_tx_tab_53_double[3 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 10 as c_int as c_double);
    ff_tx_tab_53_double[4 as c_int as usize] =
        sin(2 as c_int as c_double * 3.14159265358979323846f64 / 5 as c_int as c_double);
    ff_tx_tab_53_double[5 as c_int as usize] =
        sin(2 as c_int as c_double * 3.14159265358979323846f64 / 5 as c_int as c_double);
    ff_tx_tab_53_double[6 as c_int as usize] =
        sin(2 as c_int as c_double * 3.14159265358979323846f64 / 10 as c_int as c_double);
    ff_tx_tab_53_double[7 as c_int as usize] =
        sin(2 as c_int as c_double * 3.14159265358979323846f64 / 10 as c_int as c_double);
    ff_tx_tab_53_double[8 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 12 as c_int as c_double);
    ff_tx_tab_53_double[9 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 12 as c_int as c_double);
    ff_tx_tab_53_double[10 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 6 as c_int as c_double);
    ff_tx_tab_53_double[11 as c_int as usize] =
        cos(8 as c_int as c_double * 3.14159265358979323846f64 / 6 as c_int as c_double);
}
#[cold]
unsafe extern "C" fn ff_tx_init_tab_7_double() {
    ff_tx_tab_7_double[0 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 7 as c_int as c_double);
    ff_tx_tab_7_double[1 as c_int as usize] =
        sin(2 as c_int as c_double * 3.14159265358979323846f64 / 7 as c_int as c_double);
    ff_tx_tab_7_double[2 as c_int as usize] =
        sin(2 as c_int as c_double * 3.14159265358979323846f64 / 28 as c_int as c_double);
    ff_tx_tab_7_double[3 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 28 as c_int as c_double);
    ff_tx_tab_7_double[4 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 14 as c_int as c_double);
    ff_tx_tab_7_double[5 as c_int as usize] =
        sin(2 as c_int as c_double * 3.14159265358979323846f64 / 14 as c_int as c_double);
}
#[cold]
unsafe extern "C" fn ff_tx_init_tab_9_double() {
    ff_tx_tab_9_double[0 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 3 as c_int as c_double);
    ff_tx_tab_9_double[1 as c_int as usize] =
        sin(2 as c_int as c_double * 3.14159265358979323846f64 / 3 as c_int as c_double);
    ff_tx_tab_9_double[2 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 9 as c_int as c_double);
    ff_tx_tab_9_double[3 as c_int as usize] =
        sin(2 as c_int as c_double * 3.14159265358979323846f64 / 9 as c_int as c_double);
    ff_tx_tab_9_double[4 as c_int as usize] =
        cos(2 as c_int as c_double * 3.14159265358979323846f64 / 36 as c_int as c_double);
    ff_tx_tab_9_double[5 as c_int as usize] =
...
unsafe extern "C" fn ff_tx_mdct_naive_inv_double_c(
    ...
    while i < len {
        ...
        while j < len2 {
            ...
            let mut val: c_double = *src.offset((j as c_long * stride) as isize);
            sum_d += a_d * val;
            sum_u += a_u * val;
            j += 1;
            j;
...
unsafe extern "C" fn ff_tx_mdct_init_double_c(
    ...
    ret = ff_tx_mdct_gen_exp_double(s, if inv != 0 { (*s).map } else { 0 as *mut c_int });
    if ret != 0 {
        return ret;
    }
    if inv != 0 {
...
unsafe extern "C" fn ff_tx_rdft_r2c_double_c(
    ...
    let len2: c_int = (*s).len >> 1 as c_int;
    let len4: c_int = (*s).len >> 2 as c_int;
    let mut fact: *const TXSample = (*s).exp.double as *mut c_void as *const TXSample;
    ...
    *fresh38 = 0 as c_int as c_double;
...
unsafe extern "C" fn ff_tx_dctII_double_c(
    ...
    let len: c_int = (*s).len;
    let len2: c_int = len >> 1 as c_int;
    let mut exp: *const TXSample = (*s).exp.double as *mut c_void as *const TXSample;
...
unsafe extern "C" fn ff_tx_dctIII_double_c(
    ...
    let mut exp: *const TXSample = (*s).exp.double as *mut c_void as *const TXSample;
    let mut tmp1: TXSample = 0.;
    let mut tmp2: TXSample = 2 as c_int as c_double * *src.offset((len - 1 as c_int) as isize);
...
unsafe extern "C" fn ff_tx_dstI_double_c(
    ...
    let mut src: *mut TXSample = _src as *mut TXSample;
    let len: c_int = (*s).len + 1 as c_int;
    let mut tmp: *mut TXSample = (*s).tmp.double as *mut c_void as *mut TXSample;
    stride = (stride as c_ulong).wrapping_div(size_of::<TXSample>() as c_ulong) as ptrdiff_t
        as ptrdiff_t;
